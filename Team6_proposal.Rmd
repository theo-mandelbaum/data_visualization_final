...
world <- read_sf(here("data/ne_110m_admin_0_countries.shp"))
...
After completing our research our group found that the correlation between air quality and respiratory illnesses was not very strong. But when looking at specific pollutants such as ozone which primarily comes from vehicles the correlation was much stronger. Higher ozone levels had a strong positive correlation with higher rates of respiratory illnesses. There is also no strong correlation between the AQI and time. It had several sharp changes over the the years. On the contrary the rates of most respiratory illnesses has decreased within the past few years. Asthma rates increased between 2021 and 2022. 
