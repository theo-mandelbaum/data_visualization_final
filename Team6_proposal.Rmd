...
population_data <- read_excel(here("../co-est2020int-pop.xlsx"), skip=3)
...
In addition, we are using generic population census data from [census.gov](https://www.census.gov/data/datasets/time-series/demo/popest/intercensal-2010-2020-counties.html) for measuring population.  This screenshot was produced after cleaning the code a few blocks below:
