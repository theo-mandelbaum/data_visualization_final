...
This project aims to investigate the relationship between pollution and chronic respiratory illnesses in the United States. We chose to focus on air quality rates to measure air pollution. We also chose to focus on respiratory illnesses and cancers, since they are most likely to be affected by air quality compared to other forms of chronic illnesses. We chose to research this topic since pollution is a very prominent problem facing the United States
...
In addition, we are using generic population census data from [census.gov](https://www.census.gov/data/datasets/time-series/demo/popest/intercensal-2010-2020-counties.html) for measuring population in each . This screenshot was produced after cleaning the code a few blocks below:
